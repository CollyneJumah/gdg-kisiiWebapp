    ...
    <v-container class="pa-0">
        <v-layout wrap align-center justify-center row fill-height >
           <v-flex xs12 sm5 md3 lg3 xl3 class="text-xs-center pa-3">
                <v-img
                    :src="require('@/assets/img/gdgKisii.jpeg')"
                    :lazy-src="require('@/assets/img/gdgKisii.jpeg')"
                    width="100%">
                    <v-layout
                        slot="placeholder"
                        fill-height
            ...
            <v-flex xs12 sm7 md8 lg8 xl8 class="">
                <p class="google-font mb-1" style="font-weight: 350;color: #616161;font-size:300%"><b>Bring Techy 
                    <span style="color: #1a73e8;">to reality</span>.</b>
                </p>
